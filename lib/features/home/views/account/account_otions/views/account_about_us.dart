...
import '../../services/get_about_us_service.dart';

class AccountAboutUs extends StatefulWidget {
  const AccountAboutUs({super.key});

  @override
  State<AccountAboutUs> createState() => _AccountAboutUsState();
}

class _AccountAboutUsState extends State<AccountAboutUs> {
  String? _text;
  String? _error;
  bool _loading = true;
  ...
  Future<void> _load() async {
    try {
      final svc = Get.find<GetAboutUsService>();
      final res = await svc.getAboutUs();
      final body = res.data;
